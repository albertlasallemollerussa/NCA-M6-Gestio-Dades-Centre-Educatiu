...
En aquest programa primer has d'insertar un curs, per a que es guardi el seu id, perque es necesari per a despres insertar correctament alumnes, assignatures i professors, perque necesiten estar inscrits en un curs.
